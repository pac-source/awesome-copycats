...
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/mrmuthukaruppan/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/mrmuthukaruppan/wall.png"
theme.font                                      = "Roboto Bold 10"
theme.taglist_font                              = "Roboto Condensed Regular 8"
theme.fg_normal                                 = "#FFFFFF"
theme.fg_focus                                  = "#AF0000"
...
theme.tasklist_fg_focus                         = "#DB4C4C"
